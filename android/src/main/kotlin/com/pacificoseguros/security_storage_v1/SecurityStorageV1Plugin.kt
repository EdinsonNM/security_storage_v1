package com.pacificoseguros.security_storage_v1
...
import com.pacificoseguros.security_storage_v1.PreferenceHelper.get
import com.pacificoseguros.security_storage_v1.PreferenceHelper.set
...
public class SecurityStorageV1Plugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      ...
      channel.setMethodCallHandler(SecurityStorageV1Plugin())
      SecurityStorageV1Plugin().apply {
